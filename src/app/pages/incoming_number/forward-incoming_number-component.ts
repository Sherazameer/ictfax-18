...
export class ForwardIncomingNumberComponent implements OnInit {
  ...
  constructor(private http: HttpClient, private route: ActivatedRoute, private in_number_service: IncomingNumberService,
    ...
    this.route.params.subscribe(params => {
      ...
      if (lastsegment === 'new') {
        ...
        // return this.in_number_service.get_Data(this.id).then(data => {
          this.in_number_service.get_Data(this.id).then((data: IncomingNumber) => {
