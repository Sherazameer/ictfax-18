...
export class AddSendFaxComponent implements OnInit {
  ...
  constructor(private http: HttpClient, private route: ActivatedRoute, private document_service: DocumentService,
  ...
  file_upload() {
     this.document_service.add_Document(this.document).then((response: Document) => {  // Explicitly specify the type
